...
public class SDFGraphicEditor : Editor
{
    ...
    public static void DrawSDFScene(SignedDistanceFieldGraphic graphic)
    {
        ...
        if (circleSettings)
        {
            ...
            var fmh_304_59_638410327390306361 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 3f, Vector3.one, Handles.SphereHandleCap);
        ...
        if (maskSettings)
        {
            ...
            var fmh_329_55_638410327390331520 = Quaternion.identity; maskPos = Handles.FreeMoveHandle(maskPos, 3f, Vector3.one, Handles.SphereHandleCap);
    ...
    public void OnSceneGUI()
    {
        ...
        if (m_showPoints)
        {
            ...
            for (int i = 0; i < graphic.Points.Length; ++i)
            {
                ...
                var fmh_522_63_638410327390338924 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 5f, Vector3.zero, Handles.SphereHandleCap);
    ...
    public void OnSceneGUI()
    {
        ...
        if (m_showPoints)
        {
            ...
            for (int i = 0; i < graphic.Points.Length; ++i)
            {
                ...
                var fmh_660_63_638410327390344345 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 5f, Vector3.zero, Handles.SphereHandleCap);
